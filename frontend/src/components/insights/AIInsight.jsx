...
const AIInsight = ({ insight, loading }) => {
    return (
        <section className="glass-panel relative overflow-hidden rounded-[2rem] border-brand-400/15 p-6">
            ...
            <div className="relative mb-5 flex items-center gap-3">
                <motion.div
                    ...
                    className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-500 to-cyan-400 text-white"
                >
            ...
            {loading ? (
                ...
                <motion.p
                    ...
                    className="relative max-w-4xl text-base leading-8 text-slate-300 sm:text-lg"
                >
                    {insight}
                </motion.p>
            )}
